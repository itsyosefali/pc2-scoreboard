        ...
        <table class="table is-fullwidth is-hoverable">
          ...
          <tbody>
            ...
            >
              ...
              >
                <span 
                  v-if="team.problems[problem-1]"
                  :class="getProblemClass(team.problems[problem-1])"
                >
                  {{ getProblemSymbol(team.problems[problem-1]) }}{{ team.problems[problem-1].attempts }}
                </span>
              </td>
            </tr>
          </tbody>
      ...
      teams: [
        {
          ...
          problems: [
            ...
            { correct: true, attempts: 2 },
            { correct: false, attempts: 3 },
            { correct: true, attempts: 1 },
            { correct: true, attempts: 1 },
            { correct: true, attempts: 1 },
            { correct: true, attempts: 2 },
